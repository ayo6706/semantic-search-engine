...
class SearchSettings(BaseSettings):
    ...
    Attributes:
        ...
        RERANKER_MODEL: Hugging Face model identifier for cross-encoder reranking.
        RERANKER_CACHE_DIR: Local cache directory for reranker model files.
        RERANKER_LOCAL_FILES_ONLY: Whether reranker loading must avoid network calls.
    """
    ...
    RERANKER_CACHE_DIR: str = "/app/.cache/huggingface"
